# Contributing to uco-action

:+1: First of all: Thank you for taking the time to contribute!

The following is a set of guidelines for contributing to uco-action. 
...
The uco-action team strives to create a
...
Please use our [Issue Tracker](https://github.com/lmodel/uco-action/issues/) for reporting problems with the ontology. 
